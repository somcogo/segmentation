...
def writeSlices(series_tag_values, new_img, i, out_dir):
    ...
    image_slice.SetMetaData("0020|1041", str(i)) # Slice location
...
def nifti2dicom_1file(in_dir, out_dir):
    ...
    print((direction[0], direction[3], direction[6],# Image Orientation (Patient)
    ...
    series_tag_values = [("0008|0031",modification_time), # Series Time
                    ...
                    ("0028|0030", str([1,1])), # Pixel spacing
