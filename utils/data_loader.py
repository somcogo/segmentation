...
def getSegmentationDataLoader(batch_size, aug='nnunet', section='random', image_size=(64, 64, 64), foreground_pref_chance=0., dataset='111', distr=None):
    ...
    trn_dl = DataLoader(trn_ds, batch_size=batch_size, shuffle=(trn_sampler is None), sampler=trn_sampler, num_workers=8, pin_memory=True)
    val_dl = DataLoader(val_ds, batch_size=batch_size, shuffle=False, sampler=val_sampler, num_workers=8, pin_memory=True)
